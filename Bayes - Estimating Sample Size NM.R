...
x <- 1/Bft(se_diff , 0  , n-1, meanoftheory=0, sdtheory=1.42, dftheory=100000, tail=1)
x # 207 participants = 3.005284

# Calculate B for different sample sizes for H1
y <- Bft(se_diff , 1.42  , n-1, meanoftheory=0, sdtheory=1.42, dftheory=100000, tail=1)
y # 82 participants = 3.025246
...
plot(x = x,
     ...
     xlim=c(0,200),                          # Set limit of x-axis
