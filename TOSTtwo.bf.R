TOSTtwo.bf<-function(m1,m2,sd1,sd2,n1,n2,low_eqbound_d, high_eqbound_d, alpha, var.equal, prior_dist, effect_prior, se_prior, df_prior, uniform_lower_bound, uniform_upper_bound)
  {
  if(missing(alpha)) {
    alpha<-0.05
  }
